...
#410 registros de sleepday

n_distinct(activityday$Id)
n_distinct(activityday$date)
#940 registros de activityday

minutos_sueño_totales <- sum(sleepday$TotalMinutesAsleep)
minutos_sueño_diario_promedio <- minutos_sueño_totales / (24*60)
