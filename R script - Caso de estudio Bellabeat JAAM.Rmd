...
Dirección de los archivos y 4 grupos de archivos: 
...
Revisamos  la variable de Id para saber registros de cuantos usuarios tenemos, tambien si hay valores NA y si hay registros duplicados.
...
Si bien algunos registran datos de menos usuarios, pueden llegar a darnos información útil.

Encontramos que weight tiene 65 NA y sleepday tiene 3 filas duplicadas.

Dejamos los NA que pertenecen a la columna Fat de weight ya que no afectan, y borramos los 3 duplicados de sleepday.
...
Cambiamos las estampillas de tiempo que estan en texto a formato date o datetime.
...
Ahora unimos algunos archivos basados en su usuario Id y estampilla de tiempo, lo que sirve como identificacion unica de cada registro.
...
Hacemos un ultimo vistazo para ver que los valores tengan rangos normales.
...
Vemos que existe una correlacion positiva entre las calorías quemadas y los pasos dados, los que al mismo tiempo se relacionan positivamente con la distancia recorrida con el usuario, como es de esperarse.
```{r}
