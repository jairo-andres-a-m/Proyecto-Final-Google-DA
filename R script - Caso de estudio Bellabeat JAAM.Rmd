...
minutos_sueño_promedio <- sum(sleepday$TotalMinutesAsleep) / 410 #6.98622 horas de sueño en promedio
...
porcentaje_sedentary_sleep <- 29.10925
...
colors <- c("#398EE3", "#3674E0","#FF9612", "#A650EB", "#51BD51")

plot_ly(porcentajes_pie, 
        labels = ~Group, values = ~Percentages,
        type = 'pie', sort = FALSE,
        marker=list(colors=colors),
        textposition = 'outside',textinfo = 'label+percent') %>% 
  layout(title = '<b>Porcentaje de dia dedicado a Nivel de Actividad <b>', 
...
activityhour %>% 
    ggplot(mapping=aes(x=dia, y=TotalIntensity)) +
    geom_boxplot() + 
    scale_fill_gradient(low = "steelblue", high = "mediumseagreen") +
